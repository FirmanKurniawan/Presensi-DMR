        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              <div class="card-header"><h4>Presensi</h4></div>

              <div class="card-body">
                <form method="POST" action="/presensi" class="needs-validation" novalidate="">
                    @csrf
                    <div class="form-group">
                        <label for="name">Name</label>
                        <input id="name" type="text" class="form-control" name="name" tabindex="1" required autofocus placeholder="Insert your name">
